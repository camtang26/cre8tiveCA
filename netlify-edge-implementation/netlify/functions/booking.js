...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log('[booking] Sending to Cal.com:', JSON.stringify(bookingData, null, 2));
    ...
    console.log('[booking] Cal.com response:', JSON.stringify(result, null, 2));
    ...
    if (calcomResponse.ok && result.status === 'success') {
      ...
      console.error('[booking] Cal.com API error:', result);
      return {
        statusCode: 400,
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
